...
export const metadata: Metadata = {
  title: 'GitHub Copilot Governance & Instructions Sync | GAL',
  description: 'Sync Copilot instructions across your team. Standardize policies, maintain audit trails, stay aligned.',
  alternates: {
    canonical: 'https://gal.run/integrations/copilot',
  },
  openGraph: {
    title: 'GitHub Copilot Governance & Instructions Sync | GAL',
    description: 'Sync Copilot instructions across your team. Standardize policies, maintain audit trails, stay aligned.',
    url: 'https://gal.run/integrations/copilot',
    type: 'website',
  },
}
...
const jsonLd = {
  ...
  name: 'GAL - GitHub Copilot Integration',
      ...
      <div className="max-w-[1376px] mx-auto">
        <div className="max-w-3xl">
          ...
          <p className="text-xl text-black/60 mb-8 leading-relaxed">
            Sync .github/copilot-instructions.md across your team with one command. Standardize governance policies, maintain audit trails, and keep every developer aligned with organizational standards. Built for{' '}
            <a href="https://github.com/features/copilot" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:text-green-700 underline">
              GitHub Copilot
            </a>.
          </p>
      ...
      <div className="max-w-[1376px] mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg border border-gray-100">
            ...
            <h3 className="text-lg font-medium text-black mb-2">Inconsistent copilot-instructions.md</h3>
  ...
  const features = [
    {
      ...
      description: 'Pull approved .github/copilot-instructions.md and settings with a single command. Keep every developer on the same configuration.',
    },
    {
      icon: Shield,
      title: 'Governance Policies',
      description: 'Define org-wide rules for what Copilot can and cannot do — sensitive file indexing, context boundaries, and security standards. Active blocking enforcement is on the roadmap.',
    },
    {
      icon: Terminal,
      title: 'CLI Integration',
      description: 'GAL wraps your Copilot workflow. One command to sync, one command to verify compliance, zero friction for developers.',
    },
    {
      icon: Users,
  ...
  const steps = [
    {
      ...
      description: 'Install the GAL GitHub App to connect your repositories. GAL auto-discovers all Copilot configurations across your codebase.',
    },
    {
      step: '2',
      title: 'Define Approved Config',
      description: "Create your organization's approved .github/copilot-instructions.md and Copilot settings in the GAL dashboard.",
    },
    {
      step: '3',
...
# Pull the organization's approved Copilot configuration
gal sync --pull --agent copilot

# Output:
# ✓ .github/copilot-instructions.md updated (v3 → v4)
# ✓ .github/copilot-settings.json updated (2 new ignore patterns)
# 
# Sync complete. Copilot is now on approved baseline.`}
          </pre>
        </div>
      </div>
    </section>
...
function UseCasesSection() {
  const useCases = [
    ...
    },
    {
      ...
      description: 'Distribute coding standards via copilot-instructions.md. Share custom prompts for common workflows. Onboard new developers faster with pre-configured instructions.',
    },
    {
...
function FAQSection() {
  const faqs = [
    {
      question: 'Does GAL replace Copilot?',
      answer: 'No. GAL is a governance layer that works WITH Copilot. Your developers still use Copilot normally. GAL ensures they all use the same approved instructions and policies.',
    },
    {
      question: 'What files does GAL sync for Copilot?',
      answer: 'GAL syncs .github/copilot-instructions.md (project instructions) and Copilot settings stored in .github/copilot-settings.json.',
    },
    {
      question: 'How do developers update their config?',
      answer: 'Developers run `gal sync --pull --agent copilot` to get the latest approved configuration. You can also set up automated sync on a schedule or via CI/CD.',
    },
    {
