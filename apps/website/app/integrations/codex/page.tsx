...
export const metadata: Metadata = {
  title: 'Codex Governance & Config Sync | GAL',
  description: 'Sync Codex config across your team. Standardize policies, maintain audit trails, stay aligned.',
  alternates: {
    canonical: 'https://gal.run/integrations/codex',
  },
  openGraph: {
    title: 'Codex Governance & Config Sync | GAL',
    description: 'Sync Codex config across your team. Standardize policies, maintain audit trails, stay aligned.',
    url: 'https://gal.run/integrations/codex',
    type: 'website',
  },
}
      ...
      <div className="max-w-[1376px] mx-auto">
        <div className="max-w-3xl">
          ...
          <p className="text-xl text-black/60 mb-8 leading-relaxed">
            Sync .codex/config.toml and Codex rules across your team with one command. Standardize governance policies, maintain audit trails, and keep every developer aligned with organizational standards. Built for{' '}
            <a href="https://openai.com/codex" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:text-green-700 underline">
              Codex
            </a>.
          </p>
      ...
      <div className="max-w-[1376px] mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg border border-gray-100">
            ...
            <h3 className="text-lg font-medium text-black mb-2">Inconsistent Codex configs</h3>
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-100">
            ...
            <h3 className="text-lg font-medium text-black mb-2">Uncontrolled Context</h3>
            <p className="text-black/60">
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-100">
            ...
            <h3 className="text-lg font-medium text-black mb-2">No Team Sync</h3>
            <p className="text-black/60">
  ...
  const features = [
    {
      icon: RefreshCw,
      title: 'Config Sync',
      description: 'Pull approved .codex/config.toml, .codex/rules.md, and Codex configurations with a single command. Keep every developer on the same configuration.',
    },
    {
      icon: Shield,
      title: 'Governance Policies',
      description: 'Define org-wide rules for what Codex can and cannot do — context boundaries, security standards, and risky operations. Active blocking enforcement is on the roadmap.',
    },
    {
      icon: Terminal,
      title: 'CLI Integration',
      description: 'GAL wraps your Codex workflow. One command to sync, one command to verify compliance, zero friction for developers using OpenAI Codex.',
    },
    {
      icon: Users,
      title: 'Team Management',
      description: 'Invite team members, manage access levels, and ensure everyone runs the same baseline Codex configuration across all projects.',
    },
  ]
  ...
  const steps = [
    {
      ...
      description: 'Install the GAL GitHub App to connect your repositories. GAL auto-discovers all Codex configurations across your codebase.',
    },
    {
      step: '2',
      title: 'Define Approved Config',
      description: "Create your organization's approved .codex/config.toml, .codex/rules.md, and Codex configurations in the GAL dashboard.",
    },
    {
      step: '3',
      title: 'Developers Sync',
      description: 'Team members run `gal sync --agent codex` to get the approved configuration. Updates are distributed instantly when policies change.',
    },
  ]
  ...
  const useCases = [
    {
      ...
      description: 'Define rules for what context Codex can process. Surface sensitive-data exposure risks (active prevention coming in v1.0). Aim for every Codex session follows security policy.',
    },
    {
      title: 'Engineering Leads',
      description: 'Distribute coding standards via .codex/rules.md. Share custom rules for common workflows. Onboard new developers faster with pre-configured Codex settings.',
    },
    {
      title: 'Compliance Officers',
      description: 'Maintain audit trails of what Codex configurations were deployed. Demonstrate governance when you are audited for SOC 2 or ISO 27001.',
    },
  ]
...
function FAQSection() {
  const faqs = [
    {
      question: 'Does GAL replace Codex?',
      answer: 'No. GAL is a governance layer that works WITH Codex. Your developers still use Codex normally. GAL ensures they all use the same approved configuration and policies.',
    },
    {
      question: 'What files does GAL sync for Codex?',
      answer: 'GAL syncs .codex/config.toml (project configuration), .codex/rules.md (custom rules and instructions), and Codex model settings defined for your organization.',
    },
    {
      question: 'How do developers update their config?',
      answer: 'Developers run `gal sync --agent codex` to get the latest approved configuration. You can also set up automated sync on a schedule or via CI/CD.',
    },
    {
