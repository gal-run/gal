      ...
      <div className="max-w-[1376px] mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg border border-gray-100">
            ...
            <h3 className="text-lg font-medium text-black mb-2">Inconsistent .cursorrules</h3>
  ...
  const features = [
    {
      icon: RefreshCw,
      title: 'Rules Sync',
      description: 'Pull approved .cursorrules, settings, and MCP configurations with a single command. Keep every developer on the same configuration.',
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: 'GAL wraps your Cursor workflow. One command to sync, one command to verify compliance, zero friction for developers.',
    },
    {
      icon: Users,
  ...
  const steps = [
    {
      ...
      description: 'Install the GAL GitHub App to connect your repositories. GAL auto-discovers all Cursor configurations across your codebase.',
    },
    {
      step: '2',
      title: 'Define Approved Config',
      description: "Create your organization's approved .cursorrules, settings, and MCP configurations in the GAL dashboard.",
    },
    {
      step: '3',
...
function UseCasesSection() {
  const useCases = [
    ...
    },
    {
      ...
      description: 'Distribute coding standards via .cursorrules. Share custom prompts for common workflows. Onboard new developers faster with pre-configured rules.',
    },
    {
...
function FAQSection() {
  const faqs = [
    {
      question: 'Does GAL replace Cursor?',
      answer: 'No. GAL is a governance layer that works WITH Cursor. Your developers still use Cursor normally. GAL ensures they all use the same approved rules and policies.',
    },
    {
      question: 'What files does GAL sync for Cursor?',
      answer: 'GAL syncs .cursorrules (project rules), .cursor/settings.json (editor settings), .cursor/mcp.json (MCP server config), and custom prompts stored in .cursor/prompts/.',
    },
    {
      question: 'How do developers update their config?',
      answer: 'Developers run `gal sync --pull --agent cursor` to get the latest approved configuration. You can also set up automated sync on a schedule or via CI/CD.',
    },
    {
