...
export function parseActiveDesignProject(raw: string | undefined | null,): ActiveDesignProjectSummary | null {
 if (!raw) {
 return null;
 }
...
export function getActiveDesignProjectProgress(project: ActiveDesignProjectSummary,): number {
