...
function readCurrentGemConfig(): GeminiGemConfig | null {
 const nameInput = document.querySelector<HTMLInputElement>('input[aria-label="Input for a Gem name"]',);
 ...
 const descTextarea = document.querySelector<HTMLTextAreaElement>("textarea.description-input",);
 const description = descTextarea?.value?.trim() ?? "";

 const instructionsContainer = document.querySelector(".instructions-input-container",);
