/**
 * Regression tests — Gemini clipboard capture via MAIN world fetch.
 *
 ...
 */
async function fetchImageInPageContext(url: string,
 opts: {
 ...
 if (event.data?.type === "GAL_FETCH_IMAGE_RESULT" &&
...
describe("Gemini clipboard capture — MAIN world fetch", () => {
 ...
 const result = await fetchImageInPageContext("https://lh3.googleusercontent.com/gemini/fake-image",
 ...
 await fetchImageInPageContext("https://lh3.googleusercontent.com/gemini/another-image",
 { root: fakeRoot, win: fakeWindow },);
 ...
 const p1 = fetchImageInPageContext("https://lh3.googleusercontent.com/img1",
 { root: fakeRoot, win: fakeWindow, timeoutMs: 5000 },);
 const p2 = fetchImageInPageContext("https://lh3.googleusercontent.com/img2",
 { root: fakeRoot, win: fakeWindow, timeoutMs: 5000 },);
 ...
 const result = await fetchImageInPageContext("https://lh3.googleusercontent.com/gemini-generated-image",
 { root: fakeRoot, win: fakeWindow },);
 ...
 const result = await fetchImageInPageContext("https://lh3.googleusercontent.com/aistudio/output-image",
 { root: fakeRoot, win: fakeWindow },);
 ...
 const result = await fetchImageInPageContext("https://lh3.googleusercontent.com/gemini/image",
 { root: fakeRoot, win: fakeWindow },);
 ...
 const result = await captureImageUrl("https://lh3.googleusercontent.com/gemini/image",);
 ...
 const result = await fetchImageInPageContext("https://lh3.googleusercontent.com/gemini/auth-failed",
 { root: fakeRoot, win: fakeWindow },);
 ...
 const result = await fetchImageInPageContext("https://lh3.googleusercontent.com/gemini/http-403",
 { root: fakeRoot, win: fakeWindow },);
 ...
 // in the PR diff).
 await expect(fetchImageInPageContext("https://lh3.googleusercontent.com/gemini/csp-blocked",
 { root: fakeRoot, win: fakeWindow, timeoutMs: 50 },),).rejects.toThrow("DOM manipulation blocked by CSP");
 });
 });
 ...
 const p = fetchImageInPageContext("https://lh3.googleusercontent.com/gemini/hung-script",
 ...
 const p = fetchImageInPageContext("https://lh3.googleusercontent.com/gemini/leaked-listener",
 { root: fakeRoot, win: fakeWindow, timeoutMs: 10_000 },);
 ...
 await fetchImageInPageContext("https://lh3.googleusercontent.com/gemini/clean-response",
 { root: fakeRoot, win: fakeWindow },);
 ...
 const p = fetchImageInPageContext("https://lh3.googleusercontent.com/gemini/wrong-id",
 { root: fakeRoot, win: fakeWindow, timeoutMs: 10_000 },);
