...
describe("host-permissions helpers", () => {
 ...
 expect(originPatternFromUrl("https://aistudio.google.com/prompts/new_chat")).toBe("https://aistudio.google.com/*",);
 ...
 expect(isOptionalHostOrigin(manifest, "https://aistudio.google.com/*"),).toBe(true);
 ...
 expect(isRequestableHostOrigin(manifest, "https://midjourney.com/*"),).toBe(true);
