...
let keyCodeMap: [String: CGKeyCode] = [
    ...
    // Modifier keys (so `key`/`hold_key` can press a modifier on its own).
    "command": 0x37, "cmd": 0x37, "meta": 0x37, "shift": 0x38, "capslock": 0x39,
    "option": 0x3A, "alt": 0x3A, "control": 0x3B, "ctrl": 0x3B, "fn": 0x3F,
    // Letters (US ANSI layout) — `type` handles text, but `key` can press any letter.
