...
// ---------------------------------------------------------------------------
// Bug  — Save to GAL button must NOT appear in nav/header containers
// ---------------------------------------------------------------------------

describe("bug  — Gemini nav/header injection guard", () => {
  beforeEach(() => {
...
// ---------------------------------------------------------------------------
// Bug  — 'Use here' must work on Gemini editors (broad selector set)
// ---------------------------------------------------------------------------

describe("bug  — Gemini 'Use here' editor compatibility", () => {
...
// ---------------------------------------------------------------------------
// Bug  — Hide toggle must be respected; correct images targeted
// ---------------------------------------------------------------------------

describe("bug  — inFieldButtonDisabled preference wiring", () => {
  afterEach(() => {
    vi.resetModules();
    vi.restoreAllMocks();
    vi.unstubAllGlobals();
