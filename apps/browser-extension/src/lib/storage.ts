 ...
 */
export async function getSessionData<K extends keyof SessionStorageData>(
  key: K,
): Promise<SessionStorageData[K] | null> {
  try {
 ...
 */
export async function setSessionData<K extends keyof SessionStorageData>(
  key: K,
  value: SessionStorageData[K],
): Promise<void> {
  try {
...
export async function removeStorageData(
  keys: Array<keyof StorageData | keyof SessionStorageData>,
): Promise<void> {
  try {
...
): Promise<PlatformScanResult | null> {
 ...
 */
export async function getSyncPreference<K extends keyof SyncPreferences>(
  key: K,
): Promise<SyncPreferences[K] | null> {
  try {
 ...
 */
export async function setSyncPreference<K extends keyof SyncPreferences>(
  key: K,
