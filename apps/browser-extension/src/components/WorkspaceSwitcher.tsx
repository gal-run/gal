...
export function WorkspaceSwitcher({
  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute left-0 right-0 mt-1 z-50 rounded-lg overflow-hidden border border-gray-700 bg-gray-800 shadow-lg">
            ...
            {organizations.map((account) => {
              ...
              return (
                ...
                >
                  ...
                  {isSelected && (
                    <Check className="w-4 h-4 text-gal-accent flex-shrink-0" />
                  )}
                </button>
              );
            })}
