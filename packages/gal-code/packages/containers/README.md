...
```
REGISTRY=ghcr.io/scheduler-systems TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/scheduler-systems TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/scheduler-systems/build/bun-node:24.04
```
