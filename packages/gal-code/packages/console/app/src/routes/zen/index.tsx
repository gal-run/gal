...
import compareVideo from "../../asset/lander/gal-code-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/gal-code-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="gal-code:auth" content={loggedin() ? "true" : "false"} />
