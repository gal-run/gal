...
import desktopAppIcon from "../../asset/lander/gal-code-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://gal.run/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>gal.run/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g gal-code-ai")}>
                <code>
                  npm i -g <strong>gal-code-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g gal-code-ai")}>
                <code>
                  bun add -g <strong>gal-code-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install scheduler-systems/tap/gal-code")}>
                <code>
                  brew install <strong>scheduler-systems/tap/gal-code</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S gal-code")}>
                <code>
                  paru -S <strong>gal-code</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask gal-code-desktop")}>
                <code>
                  brew install --cask <strong>gal-code-desktop</strong>
                </code>
                <CopyStatus />
              </button>
