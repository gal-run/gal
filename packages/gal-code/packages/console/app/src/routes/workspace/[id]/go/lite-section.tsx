...
import { Database, eq, and, isNull } from "@scheduler-systems/gal-code-console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@scheduler-systems/gal-code-console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#gal-code-go")} target="_blank" rel="noopener noreferrer">
