...
beforeAll(async () => {
  ...
  mock.module("@scheduler-systems/gal-code-ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@scheduler-systems/gal-code-ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@scheduler-systems/gal-code-ui/icon", () => ({ Icon: () => null }))
  mock.module("@scheduler-systems/gal-code-ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
