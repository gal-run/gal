import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@scheduler-systems/gal-code-sdk/v2/client"
import { Button } from "@scheduler-systems/gal-code-ui/button"
import { useDialog } from "@scheduler-systems/gal-code-ui/context/dialog"
import { Dialog } from "@scheduler-systems/gal-code-ui/dialog"
import { Icon } from "@scheduler-systems/gal-code-ui/icon"
import { IconButton } from "@scheduler-systems/gal-code-ui/icon-button"
import { List, type ListRef } from "@scheduler-systems/gal-code-ui/list"
import { ProviderIcon } from "@scheduler-systems/gal-code-ui/provider-icon"
import { Spinner } from "@scheduler-systems/gal-code-ui/spinner"
import { TextField } from "@scheduler-systems/gal-code-ui/text-field"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "gal-code"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.gal/codeZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.gal/codeZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.gal/codeZen.visit.prefix")}
                <Link href="https://gal.run/zen" tabIndex={-1}>
                  {language.t("provider.connect.gal/codeZen.visit.link")}
                </Link>
                {language.t("provider.connect.gal/codeZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
