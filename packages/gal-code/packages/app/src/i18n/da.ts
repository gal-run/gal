export const dict = {
  ...
  "dialog.provider.gal/code.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.gal/code.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.gal/codeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af GAL Code",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i GAL Code.",
  ...
  "provider.connect.gal/codeZen.line1":
    "GAL Code Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.gal/codeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.gal/codeZen.visit.prefix": "Besøg ",
  "provider.connect.gal/codeZen.visit.link": "gal.run/zen",
  "provider.connect.gal/codeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i GAL Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i GAL Code.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i gal-code.json",

  "mcp.status.connected": "forbundet",
  "mcp.status.failed": "mislykkedes",
  "mcp.status.needs_auth": "kræver godkendelse",
  "mcp.status.needs_client_registration": "kræver registrering",
  "mcp.status.disabled": "deaktiveret",
  "mcp.authenticate": "Godkend",
  "mcp.authenticating": "Godkender...",
  ...
  "dialog.server.description": "Skift hvilken GAL Code-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af GAL Code ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til GAL Code-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (gal-code.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, GAL Code understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "GAL Code inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør GAL Code-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for GAL Code",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan GAL Code ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om GAL Code følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan GAL Code er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når GAL Code starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af GAL Code.",
