...
export const dict = {
  ...
  "dialog.provider.gal/code.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.gal/code.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.gal/codeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "GAL Code tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve GAL Code'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.gal/codeZen.line1":
    "GAL Code Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.gal/codeZen.visit.prefix": "",
  "provider.connect.gal/codeZen.visit.link": "gal.run/zen",
  "provider.connect.gal/codeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve GAL Code'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak GAL Code'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler gal-code.json içinde yapılandırılır",

  "mcp.status.connected": "bağlı",
  "mcp.status.failed": "başarısız",
  "mcp.status.needs_auth": "kimlik doğrulama gerekli",
  "mcp.status.needs_client_registration": "kayıt gerekli",
  "mcp.status.disabled": "devre dışı",
  "mcp.authenticate": "Doğrula",
  "mcp.authenticating": "Doğrulanıyor...",
  ...
  "dialog.server.description": "Bu uygulamanın hangi GAL Code sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "GAL Code'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı GAL Code ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (gal-code.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: GAL Code henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "GAL Code ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "GAL Code Masaüstü",
  ...
  "settings.desktop.wsl.description": "GAL Code sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "GAL Code'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "GAL Code'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "GAL Code'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "GAL Code'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "GAL Code başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "GAL Code'un en son sürümünü kullanıyorsunuz.",
