...
export const dict = {
  ...
  "dialog.provider.gal/code.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.gal/code.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.gal/codeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av GAL Code",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i GAL Code.",
  ...
  "provider.connect.gal/codeZen.line1":
    "GAL Code Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.gal/codeZen.visit.prefix": "Besøk ",
  "provider.connect.gal/codeZen.visit.link": "gal.run/zen",
  "provider.connect.gal/codeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i GAL Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i GAL Code.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i gal-code.json",

  "mcp.status.connected": "tilkoblet",
  "mcp.status.failed": "mislyktes",
  "mcp.status.needs_auth": "trenger autentisering",
  "mcp.status.needs_client_registration": "krever registrering",
  "mcp.status.disabled": "deaktivert",
  "mcp.authenticate": "Autentiser",
  "mcp.authenticating": "Autentiserer...",
  ...
  "dialog.server.description": "Bytt hvilken GAL Code-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av GAL Code ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til GAL Code-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (gal-code.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at GAL Code ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "GAL Code inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør GAL Code-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for GAL Code",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan GAL Code ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om GAL Code skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan GAL Code er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når GAL Code starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av GAL Code.",
