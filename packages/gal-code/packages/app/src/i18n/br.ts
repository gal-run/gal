export const dict = {
  ...
  "dialog.provider.gal/code.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.gal/code.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.gal/codeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo GAL Code",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no GAL Code.",
  ...
  "provider.connect.gal/codeZen.line1":
    "GAL Code Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.gal/codeZen.visit.prefix": "Visite ",
  "provider.connect.gal/codeZen.visit.link": "gal.run/zen",
  "provider.connect.gal/codeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no GAL Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no GAL Code.",
  ...
  "dialog.plugins.empty": "Plugins configurados em gal-code.json",
  "mcp.status.connected": "conectado",
  "mcp.status.failed": "falhou",
  "mcp.status.needs_auth": "precisa de autenticação",
  "mcp.status.needs_client_registration": "requer registro",
  "mcp.status.disabled": "desabilitado",
  "mcp.authenticate": "Autenticar",
  "mcp.authenticating": "Autenticando...",
  ...
  "dialog.server.description": "Trocar para qual servidor GAL Code este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do GAL Code ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do GAL Code",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (gal-code.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: GAL Code ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "GAL Code inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor GAL Code dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do GAL Code",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o GAL Code aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o GAL Code segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o GAL Code é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o GAL Code iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do GAL Code.",
