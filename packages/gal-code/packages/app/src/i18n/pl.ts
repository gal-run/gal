export const dict = {
  ...
  "dialog.provider.gal/code.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.gal/code.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.gal/codeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez GAL Code",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w GAL Code.",
  ...
  "provider.connect.gal/codeZen.line1":
    "GAL Code Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.gal/codeZen.visit.prefix": "Odwiedź ",
  "provider.connect.gal/codeZen.visit.link": "gal.run/zen",
  "provider.connect.gal/codeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w GAL Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w GAL Code.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w gal-code.json",
  "mcp.status.connected": "połączono",
  "mcp.status.failed": "niepowodzenie",
  "mcp.status.needs_auth": "wymaga autoryzacji",
  "mcp.status.needs_client_registration": "wymaga rejestracji",
  "mcp.status.disabled": "wyłączone",
  "mcp.authenticate": "Autoryzuj",
  "mcp.authenticating": "Autoryzacja...",
  ...
  "dialog.server.description": "Przełącz serwer GAL Code, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja GAL Code ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu GAL Code",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (gal-code.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, GAL Code does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "GAL Code zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the GAL Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla GAL Code",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd GAL Code na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy GAL Code ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw GAL Code.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania GAL Code",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji GAL Code.",
