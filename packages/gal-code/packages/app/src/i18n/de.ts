...
export const dict = {
  ...
  "dialog.provider.gal/code.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.gal/code.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.gal/codeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von GAL Code",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in GAL Code zu nutzen.",
  ...
  "provider.connect.gal/codeZen.line1":
    "GAL Code Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.gal/codeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.gal/codeZen.visit.link": "gal.run/zen",
  "provider.connect.gal/codeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in GAL Code zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in GAL Code zu nutzen.",
  ...
  "dialog.plugins.empty": "In gal-code.json konfigurierte Plugins",
  "mcp.status.connected": "verbunden",
  "mcp.status.failed": "fehlgeschlagen",
  "mcp.status.needs_auth": "benötigt Authentifizierung",
  "mcp.status.needs_client_registration": "Registrierung erforderlich",
  "mcp.status.disabled": "deaktiviert",
  "mcp.authenticate": "Authentifizieren",
  "mcp.authenticating": "Authentifizierung...",
  ...
  "dialog.server.description": "Wechseln Sie den GAL Code-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von GAL Code ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem GAL Code-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (gal-code.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: GAL Code unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "GAL Code enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "GAL Code-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für GAL Code ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie GAL Code auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob GAL Code dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von GAL Code anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von GAL Code automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von GAL Code.",
