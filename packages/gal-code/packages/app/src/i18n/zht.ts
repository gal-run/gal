...
export const dict = {
  ...
  "dialog.provider.gal/code.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.gal/code.tagline": "可靠的優化模型",
  "dialog.provider.gal/codeGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "GAL Code 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 GAL Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.gal/codeZen.line1": "GAL Code Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.gal/codeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.gal/codeZen.visit.prefix": "造訪 ",
  "provider.connect.gal/codeZen.visit.link": "gal.run/zen",
  "provider.connect.gal/codeZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 GAL Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 GAL Code 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 gal-code.json 中設定的外掛程式",

  "mcp.status.connected": "已連線",
  "mcp.status.failed": "失敗",
  "mcp.status.needs_auth": "需要授權",
  "mcp.status.needs_client_registration": "需要註冊",
  "mcp.status.disabled": "已停用",
  "mcp.authenticate": "認證",
  "mcp.authenticating": "認證中...",
  ...
  "dialog.server.description": "切換此應用程式連線的 GAL Code 伺服器。",
  ...
  "toast.update.description": "GAL Code 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 GAL Code 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (gal-code.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: GAL Code 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "GAL Code 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 GAL Code 伺服器。",
  ...
  "settings.general.row.language.description": "變更 GAL Code 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 GAL Code 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 GAL Code 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 GAL Code 的主題。",
  ...
  "settings.updates.row.startup.description": "在 GAL Code 啟動時自動檢查更新",
