export const dict = {
  ...
  "dialog.provider.gal/code.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.gal/code.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.gal/codeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje GAL Code",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u GAL Code-u.",
  ...
  "provider.connect.gal/codeZen.line1":
    "GAL Code Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.gal/codeZen.visit.prefix": "Posjeti ",
  "provider.connect.gal/codeZen.visit.link": "gal.run/zen",
  "provider.connect.gal/codeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u GAL Code-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u GAL Code-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u gal-code.json",

  "mcp.status.connected": "povezano",
  "mcp.status.failed": "neuspjelo",
  "mcp.status.needs_auth": "potrebna autentifikacija",
  "mcp.status.needs_client_registration": "potrebna registracija",
  "mcp.status.disabled": "onemogućeno",
  "mcp.authenticate": "Autentificiraj",
  "mcp.authenticating": "Autentificiranje...",
  ...
  "dialog.server.description": "Promijeni na koji se GAL Code server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija GAL Code-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku GAL Code timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (gal-code.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: GAL Code još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "GAL Code uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni GAL Code server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u GAL Code-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako GAL Code izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li GAL Code prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu GAL Code-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se GAL Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju GAL Code-a.",
