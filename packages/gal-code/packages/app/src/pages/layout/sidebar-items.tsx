...
import { Avatar } from "@scheduler-systems/gal-code-ui/avatar"
...
const GAL_CODE_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === GAL_CODE_PROJECT_ID ? "https://gal.run/favicon.svg" : props.project.icon?.override
          }
