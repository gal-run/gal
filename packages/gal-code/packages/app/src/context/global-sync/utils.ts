import type { Agent, Project, ProviderListResponse } from "@scheduler-systems/gal-code-sdk/v2/client"
...
export function sanitizeProject(project: Project) {
  return {
    ...project,
    commands: project.commands ? { ...project.commands } : project.commands,
    time: { ...project.time },
