export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af GAL Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af GAL Code er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'gal-code'-kommandoen.",
