...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders GAL_CODE_CALLER", () => {
    process.env["GAL_CODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode GAL_CODE_CALLER", () => {
    process.env["GAL_CODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown GAL_CODE_CALLER", () => {
    process.env["GAL_CODE_CALLER"] = "unknown"
