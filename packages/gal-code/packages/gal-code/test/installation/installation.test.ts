  ...
  describe("latest", () => {
    ...
    test("reads brew formulae API versions", async () => {
      const layer = testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("scheduler-systems/tap/gal-code")) return ""
          if (cmd === "brew" && args.includes("--formula") && args.includes("gal-code")) return "gal-code"
          return ""
        },
      )
    ...
    test("reads brew tap info JSON via CLI", async () => {
      ...
      const layer = testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("scheduler-systems/tap/gal-code") && args.includes("--formula")) return "gal-code"
