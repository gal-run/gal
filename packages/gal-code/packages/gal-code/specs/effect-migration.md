...
Practical reference for new and migrated Effect code in `packages/gal-code`.
...
export namespace Foo {
  ...
  export class Service extends Context.Service<Service, Interface>()("@gal-code/Foo") {}
...
Tool tests should use the existing Effect helpers in `packages/gal-code/test/lib/effect.ts`:
