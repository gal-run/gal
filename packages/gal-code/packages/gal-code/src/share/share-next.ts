import type * as SDK from "@scheduler-systems/gal-code-sdk/v2"
...
export namespace ShareNext {
  ...
  const disabled = process.env["GAL_CODE_DISABLE_SHARE"] === "true" || process.env["GAL_CODE_DISABLE_SHARE"] === "1"
  ...
  export class Service extends Context.Service<Service, Interface>()("@gal-code/ShareNext") {}
