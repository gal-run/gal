...
import { readRuntime } from "@/governance/runtime"
  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all GAL Code sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific GAL Code session.",
        tags: ["Session"],
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session governance runtime",
        description: "Retrieve the governance sidecar runtime summary for a specific session.",
        operationId: "session.governance.runtime",
        responses: {
          200: {
            description: "Governance runtime summary",
            content: {
              "application/json": {
                schema: resolver(
                  z.object({
      ...
      async (c) => {
        ...
        return c.json(await readRuntime(Instance.project.id, sessionID))
      },
    )
    .post(
      "/",
      describeRoute({
        ...
        description: "Create a new GAL Code session for interacting with AI assistants and managing conversations.",
    ...
    .post(
      "/:sessionID/detach",
      describeRoute({
        summary: "Move active shell to background",
        description:
          "Detach the active foreground shell for a session, freeing the session while the same background job continues running.",
        operationId: "session.detach",
        responses: {
          200: {
            description: "Detached background job",
            content: {
              "application/json": {
      ...
      async (c) => {
        const job = await SessionPrompt.detach(c.req.valid("param").sessionID)
        return c.json(job)
      },
    )
    .post(
