...
export namespace Skill {
  ...
  const GAL_CODE_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
  ...
  const loadSkills = Effect.fnUntraced(function* (
    ...
    if (!Flag.GAL_CODE_DISABLE_EXTERNAL_SKILLS) {
    ...
    for (const dir of configDirs) {
      yield* scan(state, bus, dir, GAL_CODE_SKILL_PATTERN)
    }
  ...
  export class Service extends Context.Service<Service, Interface>()("@gal-code/Skill") {}
