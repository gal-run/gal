...
export namespace ConfigPaths {
  ...
  export async function directories(directory: string, worktree: string) {
    return [
      Global.Path.config,
      ...(!Flag.GAL_CODE_DISABLE_PROJECT_CONFIG
      ...
      ...(Flag.GAL_CODE_CONFIG_DIR ? [Flag.GAL_CODE_CONFIG_DIR] : []),
    ]
  }

  export function local(dir: string) {
    if (dir === Flag.GAL_CODE_CONFIG_DIR) return true
    return dir.replaceAll("\\", "/").endsWith("/.gal/code")
  }
