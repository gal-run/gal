import type { AuthOAuthResult, Hooks } from "@scheduler-systems/gal-code-plugin"
...
export namespace ProviderAuth {
  ...
  export class Service extends Context.Service<Service, Interface>()("@gal-code/ProviderAuth") {}
