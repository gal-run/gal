...
const DEFAULT_TIMEOUT = Flag.GAL_CODE_EXPERIMENTAL_BASH_DEFAULT_TIMEOUT_MS || 2 * 60 * 1000
...
const Parameters = z.object({
  ...
  run_in_background: z
    .boolean()
    .describe("Set to true to run the command as a background job and return immediately")
    .optional(),
  workdir: z
    .string()
    .describe(
