import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@scheduler-systems/gal-code-sdk/v2"
import { SessionTurn } from "@scheduler-systems/gal-code-ui/session-turn"
import { SessionReview } from "@scheduler-systems/gal-code-ui/session-review"
import { DataProvider } from "@scheduler-systems/gal-code-ui/context"
import { FileComponentProvider } from "@scheduler-systems/gal-code-ui/context/file"
import { WorkerPoolProvider } from "@scheduler-systems/gal-code-ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@scheduler-systems/gal-code-ui/logo"
import { IconButton } from "@scheduler-systems/gal-code-ui/icon-button"
import { ProviderIcon } from "@scheduler-systems/gal-code-ui/provider-icon"
import { iife } from "@scheduler-systems/gal-code-util/iife"
import { Binary } from "@scheduler-systems/gal-code-util/binary"
import { NamedError } from "@scheduler-systems/gal-code-util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@scheduler-systems/gal-code-ui/tabs"
import { MessageNav } from "@scheduler-systems/gal-code-ui/message-nav"
import { FileSSR } from "@scheduler-systems/gal-code-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@scheduler-systems/gal-code-ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/gal-code-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | GAL Code</Title>
              </Show>
              <Meta name="description" content="gal-code - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/gal-run/gal-code"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
