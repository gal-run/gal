export const dict = {
  ...
  "desktop.menu.help.documentation": "GAL Code Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "GAL Code CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
