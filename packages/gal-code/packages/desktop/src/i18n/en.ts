export const dict = {
  ...
  "desktop.menu.help.documentation": "GAL Code Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "GAL Code CLI binary is missing. Try reinstalling the desktop app.",
