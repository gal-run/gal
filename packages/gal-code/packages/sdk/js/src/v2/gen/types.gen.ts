...
export type EventGaltViolation = {
  type: "galt.violation"
  properties: {
    type: "input_blocked" | "output_blocked" | "redaction" | "classification_violation"
...
export type EventGovernanceRuntimeUpdated = {
  type: "governance.runtime.updated"
  properties: {
    sessionID: string
...
export type BackgroundJob = {
  id: string
  kind: "bash" | "pty" | "subagent" | "prompt" | "cron_run"
  status: "queued" | "running" | "waiting" | "exited" | "failed" | "cancelled"
  sessionID: string
  messageID?: string
  callID?: string
...
export type EventBackgroundCreated = {
...
export type EventBackgroundUpdated = {
...
export type EventBackgroundOutput = {
...
export type EventBackgroundExited = {
  type: "background.exited"
  properties: {
    jobID: string
    info: BackgroundJob
  }
...
export type Event =
  ...
  | EventBackgroundCreated
  | EventBackgroundUpdated
  | EventBackgroundOutput
  | EventBackgroundExited
...
/**
 * Server configuration for GAL Code serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: gal-code.local)
   */
  mdnsDomain?: string
  /**
...
export type McpLocalConfig = {
  ...
  enabled?: boolean
  /**
   * Mark as built-in MCP (protected from removal)
   */
  builtin?: boolean
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://gal.run/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://gal.run/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
  ...
  /**
   * GAL-T Cross-Domain AI Gateway configuration
   */
  galt?: {
    /**
     * Enable GAL-T sanitization middleware
     */
    enabled?: boolean
    /**
     * URL of the GAL-T Guard service
     */
    guard_url?: string
    /**
     * Console-granted entitlements for GAL-T access
     */
    entitlements?: Array<string>
    /**
     * Timeout for sanitization requests
     */
    timeout_ms?: number
    default_classification?: "UNCLASSIFIED" | "CONFIDENTIAL" | "SECRET" | "TOP_SECRET"
...
export type Provider = {
  id: string
  name: string
  source: "env" | "secret" | "config" | "custom" | "api"
  env: Array<string>
  key?: string
  options: {
    [key: string]: unknown
...
export type BackgroundJobOutput = {
  jobID: string
  cursor: number
  next: number
  text: string
...
export type SessionGovernanceRuntimeData = {
  body?: never
  path: {
    sessionID: string
  }
...
export type SessionGovernanceRuntimeErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type SessionGovernanceRuntimeError = SessionGovernanceRuntimeErrors[keyof SessionGovernanceRuntimeErrors]

export type SessionGovernanceRuntimeResponses = {
  /**
   * Governance runtime summary
   */
  200: {
    decisions: number
    blocked: number
...
export type SessionGovernanceRuntimeResponse =
  SessionGovernanceRuntimeResponses[keyof SessionGovernanceRuntimeResponses]
...
export type SessionDetachErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type SessionDetachError = SessionDetachErrors[keyof SessionDetachErrors]

export type SessionDetachResponses = {
  /**
...
export type SessionDetachResponse = SessionDetachResponses[keyof SessionDetachResponses]
...
export type BackgroundJobsData = {
  body?: never
  path?: never
  query?: {
    directory?: string
...
export type BackgroundJobsErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type BackgroundJobsError = BackgroundJobsErrors[keyof BackgroundJobsErrors]

export type BackgroundJobsResponses = {
  /**
   * Background jobs
   */
...
export type BackgroundJobsResponse = BackgroundJobsResponses[keyof BackgroundJobsResponses]
...
export type BackgroundWaitErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type BackgroundWaitError = BackgroundWaitErrors[keyof BackgroundWaitErrors]

export type BackgroundWaitResponses = {
  /**
   * Background job
   */
  200: BackgroundJob
...
export type BackgroundWaitResponse = BackgroundWaitResponses[keyof BackgroundWaitResponses]
...
export type BackgroundWriteData = {
  body?: {
    text: string
  }
  path: {
...
export type BackgroundWriteErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type BackgroundWriteError = BackgroundWriteErrors[keyof BackgroundWriteErrors]

export type BackgroundWriteResponses = {
  /**
   * Background job
   */
  200: BackgroundJob
...
export type BackgroundWriteResponse = BackgroundWriteResponses[keyof BackgroundWriteResponses]
