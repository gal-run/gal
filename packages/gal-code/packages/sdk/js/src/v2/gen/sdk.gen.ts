...
import type {
  ...
  BackgroundJobsResponses,
  BackgroundOutputErrors,
  BackgroundOutputResponses,
  BackgroundWaitErrors,
  BackgroundWaitResponses,
  BackgroundWriteErrors,
  BackgroundWriteResponses,
  ...
  SessionDetachErrors,
  SessionDetachResponses,
  SessionDiffResponses,
  SessionForkResponses,
  SessionGetErrors,
  SessionGetResponses,
  SessionGovernanceRuntimeErrors,
  SessionGovernanceRuntimeResponses,
  SessionInitErrors,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new GalCodeClient()" to fix this error.`)
    }
    return instance
  }
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global GAL Code configuration settings and preferences.
   */
   ...
   *
   * Update global GAL Code configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the GAL Code server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the GAL Code system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all GAL Code instances, releasing all resources.
   */
   ...
   * Upgrade GAL Code
   *
   * Upgrade GAL Code to the specified version or latest if not specified.
   */
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the GAL Code system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the GAL Code system.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with GAL Code.
   */
   ...
   * Get current project
   *
   * Retrieve the currently active project that GAL Code is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by GAL Code.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current GAL Code configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update GAL Code configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local GAL Code state.
   */
...
export class Governance extends HeyApiClient {
  /**
   * Get session governance runtime
   *
   * Retrieve the governance sidecar runtime summary for a specific session.
   */
  public runtime<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<
      ...
      ThrowOnError
    >({
      url: "/session/{sessionID}/governance/runtime",
      ...options,
      ...params,
    })
  }
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all GAL Code sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new GAL Code session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific GAL Code session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
  ...
  /**
   * Move active shell to background
   *
  ...
  public detach<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<SessionDetachResponses, SessionDetachErrors, ThrowOnError>({
      url: "/session/{sessionID}/detach",
      ...options,
      ...params,
    })
  }
...
export class Background extends HeyApiClient {
   ...
   *
   * List background jobs for the current GAL Code instance.
   */
  public jobs<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<BackgroundJobsResponses, BackgroundJobsErrors, ThrowOnError>({
      url: "/background/jobs",
      ...options,
      ...params,
    })
  ...
  /**
   * Get background job output
   *
   * Read background job output from an optional cursor.
   */
  public output<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<BackgroundOutputResponses, BackgroundOutputErrors, ThrowOnError>({
      url: "/background/jobs/{jobID}/output",
      ...options,
      ...params,
    })
  }
   ...
   *
   * Wait for a background job to finish, or return current state after a timeout.
   */
  public wait<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<BackgroundWaitResponses, BackgroundWaitErrors, ThrowOnError>({
      url: "/background/jobs/{jobID}/wait",
      ...options,
      ...params,
      headers: {
        "Content-Type": "application/json",
   ...
   *
   * Cancel or kill a running background job.
   */
  public cancel<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<BackgroundCancelResponses, BackgroundCancelErrors, ThrowOnError>({
      url: "/background/jobs/{jobID}/cancel",
      ...options,
      ...params,
    })
  }
  ...
  /**
   * Write to background job
   *
   * Write stdin to a PTY-backed background job.
   */
  public write<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<BackgroundWriteResponses, BackgroundWriteErrors, ThrowOnError>({
      url: "/background/jobs/{jobID}/write",
      ...options,
      ...params,
      headers: {
        "Content-Type": "application/json",
...
export class Schedule extends HeyApiClient {
   ...
   * List schedules
   *
   * List scheduled work for the current GAL Code instance.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create schedule
   *
   * Create a session-scoped scheduled prompt.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      ...
      delay?: number
      timezone?: string
      missed?: "skip" | "catch_up_once" | "fail_closed"
      maxRuns?: number
    },
    options?: Options<never, ThrowOnError>,
  ) {
    ...
    return (options?.client ?? this.client).post<ScheduleCreateResponses, ScheduleCreateErrors, ThrowOnError>({
      url: "/schedule",
      ...options,
      ...params,
      headers: {
  ...
  public delete<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).delete<ScheduleDeleteResponses, ScheduleDeleteErrors, ThrowOnError>({
...
export class Mcp extends HeyApiClient {
   ...
   *
   * Get all tools exposed by a specific MCP server.
   */
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current GAL Code instance, releasing all resources.
   */
...
export class Path extends HeyApiClient {
   ...
   * Get paths
   *
   * Retrieve the current working directory and related path information for the GAL Code instance.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the GAL Code system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class GalCodeClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<GalCodeClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    GalCodeClient.__registry.set(this, args?.key)
  }
