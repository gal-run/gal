...
import { IconGalCode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "gal-code/session/message-v2"
import type { Message } from "gal-code/session/message"
import type { Session } from "gal-code/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.gal/code_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.gal/code_name}>
                    <IconGalCode width={16} height={16} />
                  </div>
